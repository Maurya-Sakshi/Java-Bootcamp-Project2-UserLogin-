...
*/
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 558, 378);
		...
		lblNewLabel_1.setBounds(58, 64, 85, 14);
		...
		sub1 = new JTextField();
		sub1.setBounds(164, 62, 110, 20);
		panel.add(sub1);
		sub1.setColumns(10);
		
		sub2 = new JTextField();
		sub2.setColumns(10);
		sub2.setBounds(164, 99,110, 20);
		panel.add(sub2);
		
		sub3 = new JTextField();
		sub3.setColumns(10);
		sub3.setBounds(164, 139,110, 20);
		panel.add(sub3);
		
		totalmarks = new JTextField();
		totalmarks.setColumns(10);
		totalmarks.setBounds(164, 180, 110, 20);
		...
		grade.setColumns(10);
		grade.setBounds(164, 255, 110, 20);
		panel.add(grade);
		...
		btnAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int s3 = Integer.parseInt(sub3.getText()); int total = s1 + s2 + s3;
				float avg = total/3;
